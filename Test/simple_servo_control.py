...
servo2=Scale(root, from_=servo2_angle_limit_negative, to=servo2_angle_limit_positive, orient=HORIZONTAL,resolution=0.1,length = 400, command =servo2_angle_assign)
servo2.grid(row=10, column = 1)

servo3=Scale(root, from_=servo3_angle_limit_negative, to=servo3_angle_limit_positive, orient=HORIZONTAL,resolution=0.1,length = 400, command =servo3_angle_assign)
